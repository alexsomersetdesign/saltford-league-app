...
<x-text-input name="first_name" class="border-green-700 border-1 block w-full mb-5 text-sm" />
<x-input-label class="text-green-900 font-semi-bold" for="second_name" :value="__('Last Name')" />
<x-text-input name="second_name" class="border-green-700 border-1 block w-full mb-5 text-sm" />
